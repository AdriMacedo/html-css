...
function ProductDetails() {
  ...
  const upgrades = [
    { name: 'chaise', id: 'chaise', price: 495 },
    { name: 'ottoman', id: 'ottoman', price: 345 },
    { name: 'pillows', id: 'pillows', price: 135 },
  ...
  return (
    <>
      <NavBar />
      <ProductCard label={'Nomad Colection'} imageUrl={'src/assets/assets/productsCarousel/1/product.webp'} />
      ...
      <div>
        <h5>Customizable</h5>
        <p>
          Create your ideal sectional sofa with five fabric colors, six leg finishes, and three armrest heights. You can
          even swap the reversible back cushions: one side is tufted for a classic look, the other smooth and
          contemporary.
        </p>
      </div>
      <div>
